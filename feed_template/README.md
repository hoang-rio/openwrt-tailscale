...
# [适用于 OpenWrt 的 Tailscale 软件源](https://hoang-rio.github.io/openwrt-tailscale)
...
```
src/gz openwrt-tailscale https://hoang-rio.github.io/openwrt-tailscale/{你的设备架构}
```
...
```
https://hoang-rio.github.io/openwrt-tailscale/{你的设备架构}/packages.adb
```
