...
# [Tailscale Repository for OpenWrt](https://hoang-rio.github.io/openwrt-tailscale)
...
```sh
wget -O /tmp/key-build.pub https://hoang-rio.github.io/openwrt-tailscale/key-build.pub && opkg-key add /tmp/key-build.pub
```

**2. Add the repository**

```sh
echo "src/gz openwrt-tailscale https://hoang-rio.github.io/openwrt-tailscale/$(opkg print-architecture | awk 'NF==3 && $3~/^[0-9]+$/ {print $2}' | tail -1)" >> /etc/opkg/customfeeds.conf
```
...
```
src/gz openwrt-tailscale https://hoang-rio.github.io/openwrt-tailscale/{your device architecture}
```
...
```sh
wget -O /etc/apk/keys/hoang-rio@github.io.pub https://hoang-rio.github.io/openwrt-tailscale/key-build.rsa.pub
```

**2. Add the repository**

```sh
echo "https://hoang-rio.github.io/openwrt-tailscale/$(apk --print-arch)/packages.adb" >> /etc/apk/repositories.d/customfeeds.list
```
...
```
https://hoang-rio.github.io/openwrt-tailscale/{your device architecture}/packages.adb
```
