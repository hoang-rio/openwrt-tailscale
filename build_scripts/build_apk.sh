...
# it is designed for https://github.com/hoang-rio/openwrt-tailscale project only
# and may not work properly in other environments
# author: GuNanOvO <gunanovo@gmail.com>
# repo: https://github.com/hoang-rio/openwrt-tailscale
# date: 2026/2/26
...
# see https://github.com/hoang-rio/openwrt-tailscale/tree/main/package/tailscale for details
